...
async function virtualAccount(req, res) {
    ...
    try {
        ...
        const saveVirtualAccount = await gridsession_db_1.VirutalAccount.create({
            ...
            sourceDepositInstructions: {
                ...
                bankBeneficiaryName: virtualAccount.source_deposit_instructions.bank_beneficiary_name,
                ...
                bankRoutingNumber: virtualAccount.source_deposit_instructions.bank_routing_number,
                bankAccountNumber: virtualAccount.source_deposit_instructions.bank_account_number,
